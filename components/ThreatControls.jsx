          ...
          {['high', 'medium', 'low'].map(severity => (
            <label key={severity} className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                <div className={`w-5 h-5 rounded border-2 transition-all duration-200 ${
                  localFilters.severities.includes(severity)
                    ...
                    : 'border-slate-500 group-hover:border-[#00ff88]'
                }`}>
                  {localFilters.severities.includes(severity) && (
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium capitalize text-[#00ff88]">
                  {severity}
                </span>
                <div 
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <input
              ...
              className="slider w-full h-2 bg-gradient-to-r from-[#00ff88] to-[#00cc6a] rounded-lg appearance-none cursor-pointer"
            />
