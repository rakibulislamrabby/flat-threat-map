...
export default function Tooltip({ event, x, y, visible }) {
  ...
  const getSeverityIcon = (severity) => {
    // All severities use the same icon and color for consistency
    return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="px-2 py-1 rounded-full text-xs font-semibold bg-[#00ff88]/20 text-[#00ff88] border border-[#00ff88]/30">
            {event.severity}
          </span>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[#00ff88] font-medium text-xs">Source</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[#00ff88] font-medium text-xs">Destination</span>
          </div>
          <p className="text-slate-300 text-xs font-mono ml-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[#00ff88] font-medium text-xs">Detected</span>
          </div>
          <p className="text-slate-300 text-xs font-mono ml-6">
            {formatTime(event.ts)}
          </p>
