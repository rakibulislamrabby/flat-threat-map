...
export function simulateLoop(events, onEvent, intervalMs = 200) { // Ultra-fast attacks for maximum live archer effect
  ...
  const interval = setInterval(() => {
    ...
    console.log('🚀 Simulating event:', currentIndex, event.family, 'from', event.src.lat + ',' + event.src.lon, 'to', event.dst.lat + ',' + event.dst.lon);
