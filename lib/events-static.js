...
export const SAMPLE_EVENTS = [
  // High severity threats - Country to country attacks
  {
    ts: Date.now() - 1000,
    src: { lat: 39.8283, lon: -98.5795 }, // United States center
    dst: { lat: 55.3781, lon: -3.4360 },   // United Kingdom center
    family: 'rce',
    severity: 'high'
  },
  {
    ts: Date.now() - 2000,
    src: { lat: 35.8617, lon: 104.1954 },  // China center
    dst: { lat: 39.8283, lon: -98.5795 },  // United States center
    family: 'malware',
    severity: 'high'
  },
  {
    ts: Date.now() - 3000,
    src: { lat: 61.5240, lon: 105.3188 },   // Russia center
    dst: { lat: 36.2048, lon: 138.2529 },  // Japan center
    family: 'botnet',
    severity: 'high'
  },
  
  // Medium severity threats - Country to country attacks
  {
    ts: Date.now() - 4000,
    src: { lat: 51.1657, lon: 10.4515 },   // Germany center
    dst: { lat: -25.2744, lon: 133.7751 }, // Australia center
    family: 'sql-injection',
    severity: 'medium'
  },
  {
    ts: Date.now() - 5000,
    src: { lat: 23.6345, lon: -102.5528 },  // Mexico center
    dst: { lat: 46.6034, lon: 1.8883 },    // France center
    family: 'xss',
    severity: 'medium'
  },
  {
    ts: Date.now() - 6000,
    src: { lat: -14.2350, lon: -51.9253 }, // Brazil center
    dst: { lat: 20.5937, lon: 78.9629 },   // India center
    family: 'phishing',
    severity: 'medium'
  },
